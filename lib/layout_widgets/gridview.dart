...
// will make a gridview and make a fun to find treasure among list, view will be green if found treasure else red
...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    for(int i = 0; i<16; i++){
      _areas.add(
          Area(index: i, name: 'Area $i')
      );
    }

    var rng = Random();
    _location = rng.nextInt(_areas.length);  // location to be some random number somewhere between 0 and areas.length
  }
